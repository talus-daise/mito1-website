...
document.addEventListener("DOMContentLoaded", () => {
    ...
    [
        { id: "home", href: "/mito1-website/", icon: "fa-house", text: "トップページ", is_disabled: false },
        { id: "timetable", href: "/mito1-website/timetable/", icon: "fa-calendar-days", text: "時間割", is_disabled: false },
        // { id: "tasks", href: "/mito1-website/tasks/", icon: "fa-list-check", text: "課題", is_disabled: false },
        { id: "bbs", href: "/mito1-website/bbs/", icon: "fa-chalkboard", text: "掲示板", is_disabled: false },
        { id: "question", href: "/mito1-website/question/", icon: "fa-circle-question", text: "みとい知恵袋", is_disabled: false },
        { id: "troubleshooting", href: "/mito1-website/troubleshooting/", icon: "fa-screwdriver-wrench", text: "トラブルシューティング", is_disabled: false },
        { id: "requestMusic", href: "/mito1-website/request_music/", icon: "fa-music", text: "リクエスト曲", is_disabled: false }
    ].forEach(item => {
